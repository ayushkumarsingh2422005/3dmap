  ...
  const handleMapClick = useCallback((ev: MapMouseEvent) => {
    ...
    setViewProps(p => ({
      ...
      center: {
        lat,
        lng,
        altitude: p.center.altitude // Maintain current altitude
      }
    }));
  }, []);

  const handleMarkerDragEnd = useCallback((position: google.maps.LatLngAltitudeLiteral) => {
    setViewProps(p => ({
      ...p,
      center: {
        ...position,
